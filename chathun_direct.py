import requests
from config_direct import GROQ_CHAT_URL, GROQ_MODEL

# Clé API qui fonctionne (directement codée pour éviter tout problème)
API_KEY = "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"
